...
public class Employee implements Comparable<Employee> { // implements Comparable<Employee> {
	...
	public int compareTo(Employee e) {
		// implement
		// return this.accounts.getLargest().getBalance() >
		// e.accounts.getLargest().getBalance() ? 1 : 0;
		// return this.accounts.getLargest().equals(e.accounts.getLargest()) ? 1 : 0;
