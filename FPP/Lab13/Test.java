...
public class Test extends TestCase {
	...
	@Override
	public void setUp() {
		File f = new File("/Users/User/Downloads/Documents/testCode/level1/level2/finalLevel");
		System.out.println(f.mkdirs());
		f = new File("/Users/User/Downloads/Documents/testCode/level1/level2a/thirdLevel");
		System.out.println(f.mkdirs());
		f = new File("/Users/User/Downloads/Documents/testCode/level1/level2b/thirdLevelb");
		System.out.println(f.mkdirs());
		f = new File("/Users/User/Downloads/Documents/testCode/level1/level2c/fourthLevel");
		System.out.println(f.mkdirs());
		insert = new File(f.getAbsolutePath() + "/find.txt");
