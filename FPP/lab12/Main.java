...
public class Main {
	...
	void handleWithdrawals() {
		...
		try {
			...
			System.out.println();
			System.out.println(
					"$" + amount + " has been withdrawn from the " + n + name + " account of " + emps[empChoice].getName());
...
//		} else {
//			System.out.println("Amount $" + amount + " exceeds the current balance of the " + n + name + " account of "
