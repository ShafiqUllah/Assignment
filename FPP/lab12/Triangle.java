...
public class Triangle extends ClosedCurve {
	...
	public Triangle(double side1, double side2, double side3)
			throws IllegalTriangleException, IllegalClosedCurveException {
		...
		if (x + y < z) {
			...
			throw new IllegalTriangleException(
					"An IllegalTriangleException was thrown in a " + this.toString() + " instance.");
			/*
			 * System.out.println("Illegal sizes for a triangle: "+side1+", "+side2+", "
			 * +side3); System.out.println("Using default sizes.");
			...
			throw new IllegalClosedCurveException(
					"An IllegalClosedCurveException was thrown in a " + this.toString() + " instance");
		} else {
			setSides(x, y, z);
	...
	public static void main(String[] args) {
		...
		try {
			Triangle t = new Triangle(1.41421, 1.41421, -22);
